...
const PlanCard = ({ plan }) => (
	...
	>
		...
		<button
			className={`w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg font-semibold transition-all duration-300 mt-auto cursor-pointer text-sm sm:text-base ${
				plan.mostPopular
...
const PricingPlans = () => (
	<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6 mb-16 md:mb-20 lg:mb-24">
		{plans.map((plan) => (
